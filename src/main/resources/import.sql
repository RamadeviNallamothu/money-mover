...
INSERT into account_detail (account_number,account_type,user,balance) values(12345,'Checking_Account','mark', 5000);
INSERT into account_detail (account_number,account_type,user,balance) values(12344,'Checking_Account','george', 1000);
INSERT into account_detail (account_number,account_type,user,balance) values(12333,'Saving_Account','george', 3000);
INSERT into account_detail (account_number,account_type,user,balance) values(12222,'Checking_Account','michel', 4000);
INSERT into account_detail (account_number,account_type,user,balance) values(11111,'Saving_Account','mark', 5200);
